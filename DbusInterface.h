...
public:
    static inline const char *staticInterfaceName()
    { return "net.connman.iwd.SignalLevelAgent"; }

public:
    NetConnmanIwdSignalLevelAgentInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~NetConnmanIwdSignalLevelAgentInterface();

public Q_SLOTS: // METHODS
    inline QDBusPendingReply<> Changed(const QDBusObjectPath &path, uchar signal)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(path) << QVariant::fromValue(signal);
        return asyncCallWithArgumentList(QStringLiteral("Changed"), argumentList);
    }
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<OrderedNetworkList> GetOrderedNetworks()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("GetOrderedNetworks"), argumentList);
    }

    inline QDBusPendingReply<> RegisterSignalLevelAgent(const QDBusObjectPath &path, LevelsList levels)
    {
        QList<QVariant> argumentList;
...
namespace net {
  namespace connman {
    namespace iwd {
      ...
      typedef ::NetConnmanIwdSignalLevelAgentInterface SignalLevelAgent;
